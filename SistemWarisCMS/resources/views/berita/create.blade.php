...
<head>
    ...
    <title>Tambah Berita | Sistem Ahli Waris</title>
    ...
    <div class="content">
        ...
        <header class="main-header">
            ...
            <div class="d-flex align-items-center gap-4">
                <h1 class="header-title mb-0">Tambah Berita</h1>
            </div>
                ...
                <div class="card-body">
                    <form action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('isi_konten') is-invalid @enderror" id="isi_konten" name="isi_konten">{{ old('isi_konten') }}</textarea>
