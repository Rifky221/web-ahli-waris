...
<head>
    ...
    <title>Data Berita | Sistem Ahli Waris</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .table th {
            padding: 16px; text-align: left; font-weight: 600; color: var(--gray-color);
            border-bottom: 1px solid rgba(0,0,0,0.05); font-size: 14px;
        }
        .table td {
            padding: 16px; border-bottom: 1px solid rgba(0,0,0,0.05);
            color: var(--dark-color); font-size: 15px; vertical-align: middle;
        }
        ...
        .btn-edit { background: rgba(255, 209, 102, 0.1); color: #e6b400; }
        .btn-edit:hover { background: #e6b400; color: white; }
        .btn-delete { background: rgba(239, 71, 111, 0.1); color: var(--danger-color); }
        .btn-delete:hover { background: var(--danger-color); color: white; }
        
        .status-badge {
            padding: 6px 12px; border-radius: 20px; font-size: 12px; font-weight: 600;
        }
        .status-publish { background: rgba(6, 214, 160, 0.1); color: var(--success-color); }
        .status-draft { background: rgba(139, 140, 156, 0.1); color: var(--gray-color); }
    ...
    <div class="content">
        ...
        <header class="main-header">
            ...
            <div class="d-flex align-items-center gap-4">
                <h1 class="header-title mb-0">Data Berita</h1>
            </div>
                        ...
                        <table class="table align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        @if($item->thumbnail)
                                            <img src="{{ asset('storage/' . $item->thumbnail) }}" alt="Thumbnail" width="60" height="40" style="object-fit: cover; border-radius: 8px;">
                                        @else
                                            <div style="width: 60px; height: 40px; background: #eee; border-radius: 8px; display: flex; align-items: center; justify-content: center; color: #aaa;">
                                    ...
                                    <td>{{ $item->penulis }}</td>
                                    <td><span class="badge bg-secondary bg-opacity-10 text-secondary">{{ $item->kategori }}</span></td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('berita.edit', $item->id) }}" class="btn-action btn-edit" title="Edit">
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        <img src="https://cdn-icons-png.flaticon.com/512/7486/7486754.png" alt="Empty" width="80" style="opacity: 0.5; margin-bottom: 16px;">
